...
export default function HomePage() {
  ...
  useEffect(() => {
      ...
      const calculateScale = () => {
          ...
          // Add a 5% padding so the tablet border doesn't touch the exact edge of the phone
          const scaleX = (screenWidth / BASE_WIDTH) * 0.95;
          const scaleY = (screenHeight / BASE_HEIGHT) * 0.95;
          
          const newScale = Math.min(scaleX, scaleY);
          // If the screen is smaller than 1200x750, shrink it. Otherwise, keep it 100%.
          setAppScale(newScale < 1 ? newScale : 1);
      };
  ...
  if (isShuttingDown || isPoweredOff) {
      return (
          <div className="fixed inset-0 z-99999 bg-[#0a0a0a] flex flex-col items-center justify-center text-white font-sans p-4 selection:bg-none">
              {!isPoweredOff ? (
  ...
  // --- MAIN APP ---
  return (
    <div className="fixed inset-0 w-screen h-svh bg-zinc-900 flex items-center justify-center overflow-hidden selection:bg-green-500/30">
        
        {/* GAME ENGINE SCALER WRAPPER */}
        <div 
            style={{ 
            ...
            className="shrink-0 relative transition-transform duration-200"
        >
            {/* THE DEVICE BORDER/TABLET */}
            <main className="w-full h-full flex flex-col font-sans bg-[#FF9F1C] overflow-hidden relative border-16 border-[#84CC16] rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                     ...
                     <div className="bg-[#84CC16] pt-1 pb-2 shadow-sm relative z-100">
                         ...
                         <div className="flex items-center justify-between px-4 pb-2">
                             ...
                             <div className="flex-1 max-w-xl mx-8 relative group">
                                <input type="text" placeholder="Search GEM Kids..." className="w-full rounded-full border-2 border-gray-300 bg-white py-1.5 px-4 text-lg text-gray-700 shadow-inner focus:outline-none" />
                             </div>
              ...
              <div className="flex-1 relative flex items-center justify-center py-6 z-30 overflow-y-auto">
                ...
                /* HOMEPAGE GRID */
                   ...
                   <div className="max-w-7xl w-full grid grid-cols-12 gap-x-0 px-4 h-full items-center">    
                    ...
                    <div className="col-span-4 flex flex-col justify-center gap-2 h-full py-4 pr-4 pl-1">
                      ...
                      <div onClick={() => setActiveCategory('howThingsWork')} className="relative h-28 w-full group cursor-pointer">
                          ...
                          <div className="relative h-full flex items-center justify-between px-2 flex-row-reverse">
                              ...
                              <span className="font-bold text-2xl text-gray-900 group-hover:text-white leading-tight drop-shadow-sm flex-1 text-left pl-4">How things work</span>
                          </div>
                      </div>
                    </div>
